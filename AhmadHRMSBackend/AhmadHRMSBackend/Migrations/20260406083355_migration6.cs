    ...
    public partial class migration6 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveStatus", x => x.StatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LeaveRequestsID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveRequests", x => x.LeaveRequestsID);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_EmployeeList_EmployeeId",
